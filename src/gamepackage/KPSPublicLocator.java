...
public class KPSPublicLocator extends org.apache.axis.client.Service implements gamepackage.KPSPublic {
    ...
    public KPSPublicSoap_PortType getKPSPublicSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            gamepackage.KPSPublicSoap_BindingStub _stub = new gamepackage.KPSPublicSoap_BindingStub(portAddress, this);
    ...
    public KPSPublicSoap_PortType getKPSPublicSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            gamepackage.KPSPublicSoap12Stub _stub = new gamepackage.KPSPublicSoap12Stub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (KPSPublicSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                gamepackage.KPSPublicSoap_BindingStub _stub = new gamepackage.KPSPublicSoap_BindingStub(new java.net.URL(KPSPublicSoap_address), this);
                _stub.setPortName(getKPSPublicSoapWSDDServiceName());
                return _stub;
            }
            if (KPSPublicSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                gamepackage.KPSPublicSoap12Stub _stub = new gamepackage.KPSPublicSoap12Stub(new java.net.URL(KPSPublicSoap12_address), this);
                _stub.setPortName(getKPSPublicSoap12WSDDServiceName());
                return _stub;
            }
        }
